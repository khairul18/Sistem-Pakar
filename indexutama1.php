    ...
    <main role="main">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="image/bg-1.gif" alt="Second slide">
            <div class="container">
              <div class="carousel-caption text-left">

                <h1><i>START</i></h1>
                <p><i>Simple Triage and Rapid Treatment</i></p>
                <p><button type="button" class="btn btn-lg btn-info" data-target="#exampleModal" data-toggle="modal" data-whatever="@getbootstrap">Mdulai</button></p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <img class="second-slide" src="image/bg-3.jpeg" alt="First slide">
            <div class="container">
              <div class="carousel-caption">
                <h1>START</h1>
                <p>Simple Triage and Rapid Treatment.</p>
          ...
          <div class="carousel-item">
            <img class="third-slide" src="image/bg-2.jpg" alt="Third slide">modal
            <div class="container">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                  <button type="submit" class="btn btn-info">Lanjutin ></button>
                </div>
              </form>
            </div>
      ...
      <div class="container marketing">
        ...
        <div class="row">
          <div class="col-lg-4">
            <img class="rounded-circle" src="image/gb.jpg" alt="Generic placeholder image" width="140" height="140">
            <h2>gempa bumi</h2>
          ...
          <div class="col-lg-4">
            <img class="rounded-circle" src="image/gunung.jpg" alt="Generic placeholder image" width="140" height="140">
            <h2>Letusan Gunung Berapi</h2>
            <p>sebagai Knowledge Engineer</p>
            <p>(71150055)</p>
            <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh.</p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            <img class="rounded-circle" src="image/tsunami.jpg" alt="Generic placeholder image" width="140" height="140">
            <h2>Tsunami</h2>
